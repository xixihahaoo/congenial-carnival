...
<head>
    ...
    <title data-n-head="true"><?php echo (L("position_detail")); ?></title>
...
<div id="__nuxt">
    ...
    <div data-v-3313d0ea="" class="detail">
        <div data-v-3313d0ea="" id="head">
            <div class="head_content"><h3 class="product-name"><span><?php echo (L("position_detail")); ?></span><em></em></h3>
                <div class="left"><a class="arrow_left" onclick="window.location.href='<?php echo U('trade');?>'"></a></div>
            ...
            <div data-v-3313d0ea="" class="stock-wrap">
                ...
                <div id="stock-title" class="stock-title">
                    <div class="nav-wrap"><img
                            src="/Public//Qts/Home/img/chicang/img2.png"
                            class="nav-img">
                ...
                <article class="article" style="top: 0px;">
                    <iframe id="nowtu" name='nowtu' style='width:100%;height:100%;border: 0;'
                            src="<?php echo U('Product/highcharts',array('code' => $option['capital_key'],'interval' => 'fenshi','type' => 'candlestick','height' =>350,'length' => $info['capital_length']));?>"></iframe>
                </article>
            </div>
            <!--<div data-v-3313d0ea="" class="line">-->
                <!--<img data-v-3313d0ea="" src="/Public//Qts/Home/img/chicang/img3.png">-->
            <!--</div>-->
        </div>
        <div data-v-3313d0ea="" class="con-wrap">
            <section data-v-3313d0ea="" class="con-main">
                <div data-v-3313d0ea="" class="detail-wrap">
                    <div data-v-3313d0ea="" class="detail-title">
                        <p data-v-3313d0ea="" class="variety-title">
                            <span data-v-3313d0ea="" class="variety-name"><?php echo ($order["option_name"]); ?></span>
                            <span data-v-3313d0ea="" class="buy-tag <?php echo ($order["ostyleColor"]); ?>" style="padding: .02rem .04rem"><?php echo ($order["ostyleMsg"]); ?></span>
                            <span data-v-3313d0ea="" class="right win txt_green ploss">$<?php echo ($order["ploss"]); ?></span>
                        </p>
                        
                        <?php if($order['order_scene'] == 1): ?><p data-v-3313d0ea="" class="dealer">
                            <span data-v-3313d0ea="" class="winloss">
                                <a data-v-3313d0ea="" href="javascript:;" class="bor_blue">
                                    <?php echo (L("setting_stop_loss")); ?>
                                </a>
                            </span>
                            </p><?php endif; ?>
                    ...
                    <ul data-v-3313d0ea="">
                        ...
                        <li data-v-3313d0ea="" class="detail-list">
                            <?php if($order['order_scene'] == 1): ?><div data-v-3313d0ea="" class="list-txt eee"><?php echo (L("stop_loss")); ?>
                                <em data-v-3313d0ea="" class="list-num right"><?php echo ($order["endloss"]); ?></em>
                            </div>
                            <?php else: ?>
                                <div data-v-3313d0ea="" class="list-txt eee"><?php echo (L("remaining_time")); ?>
                                    <em data-v-3313d0ea="" class="list-num right remaining_time"><?php echo ($order["remaining_time"]); ?>秒</em>
                                </div><?php endif; ?>
                            <div data-v-3313d0ea="" class="list-txt f5"><?php echo (L("current_price")); ?>
                                <em data-v-3313d0ea="" class="list-num right newPrice"><?php echo ($order["sellprice"]); ?></em>
                            </div>
                        </li>

                        <li data-v-3313d0ea="" class="detail-list">
                            <?php if($order['order_scene'] == 1): ?><div data-v-3313d0ea="" class="list-txt f5"><?php echo (L("target_profit")); ?>
                                    <em data-v-3313d0ea="" class="list-num right"><?php echo ($order["endprofit"]); ?></em>
                                </div>
                            <?php else: ?>
                                <div data-v-3313d0ea="" class="list-txt f5"><?php echo (L("hold_time")); ?>
                                    <em data-v-3313d0ea="" class="list-num right"><?php echo ($order["second"]); ?>s</em>
                                </div><?php endif; ?>
                            <div data-v-3313d0ea="" class="list-txt eee"><?php echo (L("opening_price")); ?>
                                <em data-v-3313d0ea="" class="list-num right openPrice"><?php echo ($order["buyprice"]); ?></em>
                            </div>
                        </li>

                        <li data-v-3313d0ea="" class="detail-list">
                            <?php if($order['order_scene'] == 1): ?><div data-v-3313d0ea="" class="list-txt eee"><?php echo (L("trade_lots")); ?>
                                    <em data-v-3313d0ea="" class="list-num right"><?php echo ($order["onumber"]); ?></em>
                                </div>
                                <div data-v-3313d0ea="" class="list-txt f5"><?php echo (L("bond")); ?>
                                    <em data-v-3313d0ea="" class="list-num right">$<?php echo ($order["Bond"]); ?></em>
                                </div>
                            <?php else: ?>
                                <div data-v-3313d0ea="" class="list-txt eee"><?php echo (L("bond")); ?>
                                    <em data-v-3313d0ea="" class="list-num right">$<?php echo ($order["Bond"]); ?></em>
                                </div>
                                <div data-v-3313d0ea="" class="list-txt f5"><?php echo (L("fee")); ?>
                                    <em data-v-3313d0ea="" class="list-num right">$<?php echo ((isset($order["fee"]) && ($order["fee"] !== ""))?($order["fee"]):'-'); ?></em>
                                </div><?php endif; ?>
                        </li>
    
                        <?php if($order['order_scene'] == 1): ?><li data-v-3313d0ea="" class="detail-list">
                                <div data-v-3313d0ea="" class="list-txt f5"><?php echo (L("stock")); ?>
                                    <em data-v-3313d0ea="" class="list-num right"><?php echo ((isset($order["overnight_fee"]) && ($order["overnight_fee"] !== ""))?($order["overnight_fee"]):'-'); ?></em>
                                </div>
                                <div data-v-3313d0ea="" class="list-txt eee"><?php echo (L("fee")); ?>
                                    <em data-v-3313d0ea="" class="list-num right">$<?php echo ((isset($order["fee"]) && ($order["fee"] !== ""))?($order["fee"]):'-'); ?></em>
                                </div>
                            </li><?php endif; ?>
                ...
                <div data-v-3313d0ea="" class="order-info">
                    <p data-v-3313d0ea=""><?php echo (L("open_time")); ?>:<?php echo date('Y/m/d H:i:s',$order['buytime']);?></p>
                    <p data-v-3313d0ea=""><?php echo (L("orderno")); ?>:<?php echo ($order["orderno"]); ?></p>
                </div>
    
                <?php if($order['order_scene'] == 1): ?><div data-v-3313d0ea="" class="detail-btn">
                        <a data-v-3313d0ea="" href="javascript:;" class="bg_blue" onclick="single(this);"><?php echo (L("chasing_list")); ?></a>
                        <a data-v-3313d0ea="" href="javascript:;" class="bg_blue flex" onclick="returnSingle();"><?php echo (L("close_orders")); ?></a>
                        <a data-v-3313d0ea="" href="javascript:;" class="bor_blue"><?php echo (L("close_position")); ?></a>
                    </div><?php endif; ?>
        ...
        <div data-v-3313d0ea="" class="box">
            <div class="qts-window">
                <div class="qts-img">
                    ...
                    <p class="qts-order"><?php echo (L("orderno")); ?>：<?php echo ($order["orderno"]); ?></p>
                    <div class="qts-content">
                        <ul id="cover">
                            <li><span class="txt_black"><?php echo (L("float_ploss")); ?>：</span><span class="txt_red">$<?php echo ($order["ploss"]); ?></span></li>
                            <li><span class="txt_black"><?php echo (L("opening_price")); ?>：</span><span class="txt_black"><?php echo ($order["buyprice"]); ?></span></li>
                            <li><span class="txt_black"><?php echo (L("current_price")); ?>：</span><span class="txt_black"><?php echo ($order["sellprice"]); ?></span></li>
                        </ul>
                    </div>
        ...
        <div data-v-3313d0ea="">
            <div id="popup-box" class="popup-window">
                <div class="popup-img">
                    <div class="popup-title"><?php echo ($order["option_name"]); ?><span class="buy-tag <?php echo ($order["ostyleColor"]); ?>" style="padding: .02rem .04rem"><?php echo ($order["ostyleMsg"]); ?></span><em>x<?php echo ($order["onumber"]); ?> <?php echo (L("lots")); ?></em>
                    </div>
                    <div class="popup-content">

                        <div class="popup">
                            <ul>
                                <li><span class="left"><?php echo (L("opening_price")); ?></span><span class="right"><?php echo ($order["buyprice"]); ?></span></li>
                                <li><span><?php echo (L("current_price")); ?></span><span class="right alertNewPrice"><?php echo ($order["sellprice"]); ?></span></li>
                            </ul>
                        </div>

                        <div class="list clearfix">
                            <div>
                                <span class="con-txt"><?php echo (L("stop_loss")); ?></span>
                                <div class="con-right right taparea">
                                    <em class="icon-min" onclick="loss(this,2,1)"></em>
                                    <input type="number" value="<?php echo ($order["endloss"]); ?>" class="handnum lossWinInput endloss" onchange="targetMarket(this,'EstimatePloss',2)">
                                    <em class="icon-add" onclick="loss(this,1,1)"></em>
                                </div>
                            </div>
                            <p class="right clearfix EstimatePloss">
                                <?php echo ($order["lossSymbol"]); ?><em><?php echo ($order["sellprice"]); ?></em> <?php echo (L("expected_losses")); ?> <em>$<?php echo ($order["lossLoss"]); ?></em>
                            </p>
                        </div>

                        <div class="list clearfix">
                            <div>
                                <span class="con-txt"><?php echo (L("target_profit")); ?></span>
                                <div class="con-right right taparea">
                                    <em class="icon-min" onclick="loss(this,2,2);"></em>
                                    <input type="number" value="<?php echo ($order["endprofit"]); ?>" class="handnum lossWinInput endprofit" onchange="targetMarket(this,'EstimateProfit',1)">
                                    <em class="icon-add" onclick="loss(this,1,2)"></em>
                                </div>
                            </div>
                            <p class="right clearfix EstimateProfit">
                                <?php echo ($order["profitSymbol"]); ?><em><?php echo ($order["sellprice"]); ?></em> <?php echo (L("expected_profits")); ?> <em>$<?php echo ($order["lossLoss"]); ?></em>
                            </p>
                        </div>

                    </div>
                    <div class="btns">
                        <a class="btn-cancel"><?php echo (L("cancel")); ?></a>
                        <a class="btn-ok" onclick="saveProfitAndLoss();"><?php echo (L("determine")); ?></a>
                    </div>
                </div>
            </div>
        </div>
...
$('.detail-btn .bor_blue').click(function () {
    ...
    $('.stock-tab li').click(function () {
        ...
        var src = '<?php echo U("Product/highcharts");?>' + "?code=" + code + "&interval=" + interval + "&type=" + type + "&height=" + height + "&length=" + length + "";
        $('#nowtu').attr('src', src)
    ...
    function loss(obj, type, stop_type) {
        ...
        var marketBond  = "<?php echo ($order["Bond"]); ?>";
        var ostyle      = "<?php echo ($order["ostyle"]); ?>"; //买入方向 0涨 1跌
        var number      = "<?php echo ($order["onumber"]); ?>";
    ...
    function calculationPrice() {
        var ostyle = "<?php echo ($order["ostyle"]); ?>";
    ...
    function SettingLoss() {
        ...
        wave = wave * number;
        var ostyle = "<?php echo ($order["ostyle"]); ?>"; //0涨 1跌
   ...
   */
    function targetMarket(obj,className,stop)
    {
        ...
        var ostyle      = "<?php echo ($order["ostyle"]); ?>";        //0买入 1卖出
...
<script type="text/javascript">
    ...
    function saveProfitAndLoss() {
        ...
        $.ajax({
            url: "<?php echo U('saveProfitAndLoss');?>",
            dataType: 'json',
            type: 'post',
    ...
    function cover() {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                layer.close(index);
                if(data.code == 200){
                    setTimeout(" window.location.href='<?php echo U('trade');?>'",1000);
                }
            },
            error: function (res) {
                console.log(res);
...
<script type="text/javascript">
    ...
    function single()
    {
        var option_name = "<?php echo ($order["option_name"]); ?>";
        var ostyle      = "<?php echo ($order["ostyle"]); ?>" == 0 ? '<?php echo (L("api_buy")); ?>' : '<?php echo (L("api_sell")); ?>';
        var onumber     = "<?php echo ($order["onumber"]); ?>";


            var msg = '<?php echo (L("make_sure")); ?>'+' '+option_name+' '+ostyle+' '+onumber+' <?php echo (L("lots")); ?>?';
        layer.open({
            content: msg
            ...
            var pid     = "<?php echo ($order["pid"]); ?>";                           //下单产品
            var ostyle  = "<?php echo ($order["ostyle"]); ?>";                        //下单方向 0涨 1跌
            var number  = "<?php echo ($order["onumber"]); ?>";                       //下单手数
            var bond    = "<?php echo ($order["Bond"]); ?>";                          //下单保证金
    ...
    function returnSingle()
    {
        ...
        //追返单
        var pid     = "<?php echo ($order["pid"]); ?>";                           //下单产品
        var ostyle  = "<?php echo ($order["ostyle"]); ?>" == 0 ? 1: 0;            //下单方向 0涨 1跌
        var number  = "<?php echo ($order["onumber"]); ?>";                       //下单手数
        var bond    = "<?php echo ($order["Bond"]); ?>";                          //下单保证金
