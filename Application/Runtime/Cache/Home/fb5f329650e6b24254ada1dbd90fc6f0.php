...
<div id="__nuxt">
    ...
    <div data-v-6524b236="" class="">

        <div data-v-6524b236="" id="head">
            <div data-v-6524b236="" class="head_content">
                <ul data-v-6524b236="" class="head_tab">
                    <li data="1" data-v-6524b236="" class="head_list"><?php echo (L("simple")); ?></li>
                    <li data="2" data-v-6524b236="" class="head_list"><?php echo (L("senior")); ?></li>
                    <li data="3" data-v-6524b236="" class="tab_checked2 head_list"><?php echo (L("time")); ?></li>
                </ul>
        ...
        <section data-v-6524b236="" class="page-main">
            <div data-v-6524b236="" class="variety-top">
                <p data-v-6524b236="" class="variety-type">
                    ...
                    <a href="<?php echo U('playIntroduce',array('pid' => $option['id']));?>"> <span data-v-6524b236="" class="rule"><?php echo (L("rules")); ?></span></a>
                ...
                <a href="<?php echo U('Position/trade');?>">
                    <div data-v-6524b236="" class="right"><?php echo (L("position")); ?></div>
                </a>
            </div>
            ...
            <div data-v-6524b236="" class="content-wrap">
                <div data-v-6524b236="" class="stock-wrap">
                    ...
                    <article class="article">
                        <iframe  id="nowtu" name='nowtu' style='width:100%;height:100%;border: 0;' src="<?php echo U('highcharts',array('code' => $option['capital_key'],'interval' => 'fenshi','type' => 'candlestick','height' =>450,'length' => $info['capital_length']));?>"></iframe>
                    </article>
                </div>

                <!-- 闪电下单 -->
                <div data-v-6524b236="" class="none top">
                        ...
                        <div data-v-6524b236="" class="list clearfix quick-w">
                            ...
                            <div data-v-6524b236="" class="quick-w2">
                                ...
                                <div data-v-6524b236="" class="con-right taparea">
                                    ...
                                    <input data-v-6524b236="" type="number" value="5.00" class="handnum hands" onkeyup="hands(this,'bond')" id="lightning_number" autofocus>
                        ...
                        <div data-v-6524b236="" class="list clearfix quick-w">
                            ...
                            <div data-v-6524b236="" class="quick-w2">
                                <div data-v-6524b236="" class="con-right">
                                    <span data-v-6524b236="" class="quick-hand active" id="bondLever">0</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div data-v-6524b236="" class="btn-wrap" style="bottom: 0.2rem;">
                        <div data-v-6524b236="" class="right quick-btn">
                            <a data-v-6524b236="" href="javascript:;" class="con-btn txt_red" data-ostyle=1>
                            ...
                            <a data-v-6524b236="" href="javascript:;" class="con-btn txt_green"  data-ostyle="0">
                ...
                <div data-v-6524b236="" class="none top buy-wrap">
                        ...
                        <div data-v-6524b236="" class="trade-con">
                            <div data-v-6524b236="" class="list clearfix">
                                ...
                                <div data-v-6524b236="" class="con-right right buy_wrap">
                                    <a data-v-6524b236="" href="javascript:;" class="con-btn txt_red buy_check" data-ostyle=1>
                            ...
                            <div data-v-6524b236="" class="list clearfix quick-w">
                                ...
                                <div data-v-6524b236="" class="quick-w2">
                                    <div data-v-6524b236="" class="con-right">
                                        <span data-v-6524b236="" class="quick-hand active" id="marketBondLever">0</span>
                                    </div>
                                </div>
                            </div>
                            <!-- 对应杠杆 End-->
                    ...
                    <div data-v-6524b236="" class="btn-wrap buy-wrap" style="bottom: 0.2rem;">
                        <button data-v-6524b236="" class="btn bg_blue marketPrice marketSubmit">
                            <?php if(($now_trade_status) == "2"): echo (L("market_price_sell")); ?>(<?php echo (L("simulation")); ?>)
                                <?php else: ?>
                                <?php echo (L("market_price_sell")); endif; ?>
                        </button>
                        <button data-v-6524b236="" class="btn bg_blue guadanSubmit" style="display: none">
                ...
                <div class="block top timeTabContent">
                    <div class="timeTabBtn">
                        <div class="">
                            <p class="sellOut border_red" data-ostyle="1">
                            ...
                            <p class="sellOut border_green" data-ostyle="0">
...
<ion-view class="trade-view">
    ...
    <div class="order_mengban glass_masks" id="div2" style="">
        <div>
            <div>
                <div class="order-state-panel" style="display: block;">
                    <div class="panel-header">
...
<script type="text/javascript">
    ...
    function number(obj,className)
    {
        ...
        $(obj).parent().siblings().find('input').val(val);
