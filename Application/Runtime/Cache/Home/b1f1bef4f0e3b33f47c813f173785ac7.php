...
<title data-n-head="true"><?php echo (L("lang_choice")); ?></title>
...
<div id="__nuxt">
	...
	<div data-v-4dec191d="" class="content">
		<div data-v-4dec191d="" id="head">
			<div class="head_content"><h3 class="product-name"><span style="color: #ffbf23"><?php echo (L("lang_choice")); ?></span><em></em></h3>
		...
		<section data-v-4dec191d="" class="page-main" style="padding-bottom: 0.5rem;">
			...
			<div data-v-4dec191d="" class="list">
				...
				<?php if((${lang}) == "zh-cn"): ?><div data-v-4dec191d="" class="all-same exitOut">
						<div data-v-4dec191d=""><?php echo (L("zh_cn")); ?></div>
					</div>
				<?php else: ?>
					<a href="/?l=zh-cn">
				...
				<?php if((${lang}) == "zh-tw"): ?><div data-v-4dec191d="" class="all-same exitOut">
						<div data-v-4dec191d=""><?php echo (L("zh_tw")); ?></div>
					</div>
				<?php else: ?>
					<a href="/?l=zh-tw">
						<div data-v-4dec191d="" class="all-same">
				...
				<?php if((${lang}) == "en-us"): ?><div data-v-4dec191d="" class="all-same exitOut">
						<div data-v-4dec191d=""><?php echo (L("en_us")); ?></div>
					</div>
				<?php else: ?>
					<a href="/?l=en-us">
						<div data-v-4dec191d="" class="all-same">
