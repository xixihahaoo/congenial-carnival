...
<div class="content">
    ...
    <link href="/Public/Admin/css/lib/bootstrap-wysihtml5.css" type="text/css" rel="stylesheet" />
    <link href="/Public/Admin/css/lib/uniform.default.css" type="text/css" rel="stylesheet" />
...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
  <legend>系统禁止下单时间</legend>
</fieldset>
<div id="pad-wrapper" class="form-page">
    <div class="row-fluid form-wrapper">
    <div class="field-box">
        <label>系统禁止下单时间设置：</label>
        <input type="text" name="sys_date" value="<?php echo ($sys_date); ?>" id="sys_date" lay-verify="title" autocomplete="off"  placeholder="请输入时间（分钟）" class="layui-input">分钟
    </div>
    <div class="field-box">
        注：设置禁止下单时间后，系统会在当前设置的时间减去正常休市后的时间，全部禁止下单。<br>
        例如，设置的商品交易时间为9:00--11:00，设置的系统禁止下单时间为5（分钟）<br>
        系统会在10:55禁止下单，在10:55--11:00区间内，点位正常变化，不可下单。
    </div>
...
<script>
 ...
 $(".layui-btn").click(function(){
          ...
          var sys_date  = $("#sys_date").val();
            ...
            $.ajax({
                url: "<?php echo U('Tools/product_sell_time_opt');?>",
                dataType: 'json',
                type: 'post',
                data: {'sys_date':sys_date},
