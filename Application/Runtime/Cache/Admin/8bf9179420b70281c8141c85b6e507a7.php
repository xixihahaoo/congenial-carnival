...
<form id="submit" method="post">
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline layui-form-mid layui-word-aux">
      <?php echo ($username); ?> [ <?php echo ($uid); ?> ]
    </div>
  </div>
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline">
	  ...
	  <input type="hidden" name="uid" id="uid" value="<?php echo ($uid); ?>" lay-verify="uid" autocomplete="off" class="layui-input">
    </div>
  </div>
</form>
