            ...
            <div id="pad-wrapper" class="users-list">
                ...
                <div class="row-fluid table header">
                    <table class="table table-hover">
                        ...
                        <tbody>
                        <?php if(is_array($bank)): $i = 0; $__LIST__ = $bank;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ult): $mod = ($i % 2 );++$i;?><tr class="first">
                                <td>
                                    <?php echo ($ult['bid']); ?>
                                </td>
                                <td>
                                    <?php echo ($ult['bankname']); ?>
                                </td>
                                <td>
                                    <?php echo ($ult['branch']); ?>
                                </td>
                                <td>
                                    <?php echo ($ult['swiftcode']); ?>
                                </td>
                                <td>
                                    <?php echo ($ult['address']); ?>
                                </td>
                                <td>
                                    <?php echo ($ult['banknumber']); ?>
                                </td>
                                <td>
                                    <?php echo ($ult['busername']); ?>
                                </td>
                                <td>
                                    <?php echo ($ult['tel']); ?>
                                </td>
                                <td>
                                     <img src="/Uploads/<?php echo ($ult['bank_img']); ?>" style="width: 18%;">
                                </td>
                                <td>
                                    <?php echo ($ult['tempdate']); ?>
                                </td>
                                <td>
                                    <ul class="actions">
                                        <li><a href="<?php echo U('updateBank',array('bid'=>$ult['bid']));?>"><i class="table-edit"></i></a></li>
                                        <li class="last"><a href="<?php echo U('delBankInfo',array('bid'=>$ult['bid']));?>" onclick="if(confirm('确定要删除吗?')){return true;}else{return false;}"><i class="table-delete"></i></a></li>
                                    </ul>
                                </td>
