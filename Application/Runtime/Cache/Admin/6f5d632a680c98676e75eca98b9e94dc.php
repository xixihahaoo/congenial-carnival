   ...
   <div class="container-fluid">
            <div id="pad-wrapper" class="new-user">
                ...
                <div class="row-fluid form-wrapper row">
                    <form  method="post" class="new_user_form" action="<?php echo U(User/updateuser);?>" style="overflow: hidden">
                        ...
                        <div class="span6 with-sidebar col-sm-12 col-md-8" style="display: inline-block">
                            <div class="span9 field-box uname" style="margin-top: 20px;">
                                <label>用户昵称:</label>
                                <input class="span3" type="text" name="nickname" value="<?php echo ($userme['nickname']); ?>" readonly="true"/>
                            </div>
                            <!--<div class="span9 field-box">-->
                                <!--<label>真实姓名:</label>-->
                                  <!--<input class="span8" type="text" name="real_name" value="<?php echo ($person['real_name']); ?>" disabled="" />-->
                            <!--</div>-->

                            <div class="span9 field-box">
                                <label>邮箱:</label>
                                <input class="span8" disabled type="text" name="email" value="<?php echo ($userme['email']); ?>" />
                            </div>
                            ...
                            <div class="span9 field-box">
                                ...
                                <span><?php echo ($account["gold"]); ?></span>
                                &nbsp;输入”-“可减去模拟金额
                            </div>
                            ...
                            <!--<div class="span9 field-box">-->
                                ...
                                <!--<span><?php echo ($account["integral"]); ?></span>-->
                                <!--积分&nbsp;输入”-“可减去积分-->
                            <!--</div>-->
                            ...
                            <!--<div class="span9 field-box">-->
                                <!--<label>身份证号码:</label>-->
                                <!--<input class="span8" type="text" name="card" value="<?php echo ($person['card']); ?>" disabled="" />-->
                            <!--</div>-->
                            <!--<div class="span9 field-box">-->
                                <!--<label>当前省市:</label>-->
                                <!--<select id="selProvince" class="f-select span2" name="province" disabled="">-->
                                    <!--<?php if(is_array($province)): $i = 0; $__LIST__ = $province;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>-->
                                        <!--<?php if(($person['province']) == $vo['id']): ?>-->
                                            <!--<option value="<?php echo ($vo["id"]); ?>" selected><?php echo ($vo["joinname"]); ?></option>-->
                                        <!--<?php else: ?>-->
                                            <!--<option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["joinname"]); ?></option>-->
                                        <!--<?php endif; ?>-->
                        ...
                        <!--<?php if(!empty($person['card'])): ?>-->
                            <!--<div class="col-sm-12 col-md-4" style="padding-left: 100px;display: inline-block">-->
                                <!--<div style="margin-bottom: 20px"><img style="max-width: 300px" src="/Uploads/<?php echo ($person["card_positive"]); ?>" alt=""></div>-->
                                <!--<div><img style="max-width: 300px" src="/Uploads/<?php echo ($person["card_side"]); ?>" alt=""></div>-->
                            <!--</div>-->
                        <!--<?php endif; ?>-->
                    </form>
