    ...
    <div class="container-fluid">
        <div id="pad-wrapper" class="users-list">
            <div class="row-fluid header" style="margin-bottom: 10px">
                <form id="form1" action="/login/operate/index" method="get">
...
<!--                         <a href="javascript:void(0)" class="btn-flat info" onclick="sub()">查找导出</a> -->
                ...
                <table class="table table-hover layui-table">
                    ...
                    <?php if(is_array($user)): $i = 0; $__LIST__ = $user;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ult): $mod = ($i % 2 );++$i;?><!-- row -->
                        <tr class="first">
                            ...
                            <td>
                                <a href="javascript:void(0)" style="color:red" onclick="showdetail(<?php echo ($ult['uid']); ?>)" title="查看资金详情">
                                    <span><?php echo ($ult['username']); ?></span>
                                    <?php if(($ult['is_default']) == "1"): ?>(默认)<?php endif; ?>
                                </a>
                            </td>
    ...
    <script type="text/javascript">
        ...
        function sub()
        {
            $('#form1').attr("action","/login/operate/daochu");
            $('#form1').submit();
        }

        function submit() {

            $('#form1').attr("action","/login/operate/index");
            $('#form1').submit();
        }
