...
class CashorderController extends CommonController
{
    /**
    ...
    public function ajax_get_brokers(){
        if(IS_AJAX){
            ...
            $res = $userobj->field('a.uid,a.username,b.real_name')->join('left join wp_personal_user_data as b on a.uid = b.uid')->where($where)->order('uid DESC')->select();
