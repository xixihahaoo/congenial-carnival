...
class Memcache {//类定义开始
	...
	public function write($sessID, $sessData) {
		$onlineUsers = self::$mHandle->get("online_user");
		$onlineUsers[$sessID] = array_merge($_SESSION,array('lasttime'=>time()));
		self::$mHandle->set("online_user",$onlineUsers);
	...
	public function destroy($sessID) {
		...
		$onlineUsers = self::$mHandle->get("online_user");
		if (isset($onlineUsers[$sessID])) {
			unset($onlineUsers[$sessID]);
			self::$mHandle->set("online_user",$onlineUsers);
		}
