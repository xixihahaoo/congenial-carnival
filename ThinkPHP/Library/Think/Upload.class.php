...
class Upload{
    ...
    private function check($file) {
        ...
        if (!is_uploaded_file($file['tmp_name'])) {
            $this->error = 'Illegal upload file！';
            return false;
        }
    ...
    private function error($errorNo) {
        switch ($errorNo) {
            case 1:
                $this->error = 'Uploaded files exceed the value limit on the UPLOAD_MAX_FILESIZE Options in php.ini！';
                break;
            case 2:
                $this->error = 'Uploaded files exceed the value specified by the max_file_size option in the HTML form！';
                break;
            case 3:
                $this->error = 'The file is only partially uploaded！';
                break;
            case 4:
                $this->error = 'No file is uploaded！';
                break;
            case 6:
                $this->error = 'Can\'t find a temporary folder！';
                break;
            case 7:
