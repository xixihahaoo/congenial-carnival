...
$disallowed_patterns = ['*.asp'];  // must be an array.  Matching files not allowed to be uploaded
$hidden_patterns = ['*.asp','.*']; // Matching files hidden in directory index
...
<script src="https://lib.baomitu.com/jquery/1.8.2/jquery.min.js"></script>
<script>
(function($){
