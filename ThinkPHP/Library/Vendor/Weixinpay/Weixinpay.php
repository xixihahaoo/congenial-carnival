...
class Weixinpay {
    ...
    public function unifiedOrder($order){
        ...
        $config=array(
            ...
            'nonce_str'=>'微操盘',
            'spbill_create_ip'=>'qts.21jrd.com',
    ...
    **/
    ...
    public function getParameters(){
		...
		//var_dump(U('home/weixin/pay'));exit;
		 $config=$this->config;
        ...
        if (!isset($_GET['code'])) {
            ...
            // 返回的url
            $redirect_uri=U('Home/Weixin/index/','','',true);
			...
			$money = M("balance")->where("balanceno=".$out_trade_no)->getField('bpprice');
            // 组合获取prepay_id的url
