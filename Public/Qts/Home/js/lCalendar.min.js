    ...
    return a.prototype = {
        init: function (a) {
            ...
            function b(a) {
                ...
                var e = t.gearDate.querySelector(".date_yy"), f = t.gearDate.querySelector(".date_mm"),
            ...
            function c() {
                var a = new Date, b = {yy: a.getYear(), mm: a.getMonth(), dd: a.getDate() - 1};
            ...
            function d(a) {
                ...
                var d = t.gearDate.querySelector(".date_yy"), f = t.gearDate.querySelector(".date_mm"),
                    g = t.gearDate.querySelector(".date_dd"), h = t.gearDate.querySelector(".time_hh"),
            ...
            function e() {
                var a = new Date,
                    b = {yy: a.getYear(), mm: a.getMonth(), dd: a.getDate() - 1, hh: a.getHours(), mi: a.getMinutes()};
            ...
            function f(a) {
                ...
                var d = t.gearDate.querySelector(".time_hh"), e = t.gearDate.querySelector(".time_mm");
            ...
            function g() {
                var a = new Date, b = {hh: a.getHours(), mm: a.getMinutes()};
            ...
            function h() {
                var a = t.maxY - t.minY + 1, b = t.gearDate.querySelector(".date_yy"), c = "";
                if (b && b.getAttribute("val")) {
                    ...
                    if (isNaN(f)) b.style["-webkit-transform"] = "translate3d(0," + (8 - 2 * d) + "em,0)", b.setAttribute("top", 8 - 2 * d + "em"); else {
                    ...
                    if (h && h.getAttribute("val")) {
                        c = "";
                        var i = parseInt(h.getAttribute("val")), k = 11, l = 0;
                        ...
                        if (m && m.getAttribute("val")) {
                            c = "";
                            var n = parseInt(m.getAttribute("val")), o = j(d, i), p = o - 1, q = 0;
            ...
            function n(a) {
                var b = 0, c = !1, d = t.maxY - t.minY + 1;
                clearInterval(a["int_" + a.id]), a["int_" + a.id] = setInterval(function () {
                    var e = a["pos_" + a.id], f = a["spd_" + a.id] * Math.exp(-.03 * b);
                    if (e += f, Math.abs(f) > .1) ; else {
                        f = .1;
                    ...
                    switch (e > 8 && (e = 8, c = !0), a.dataset.datetype) {
                        case"date_yy":
                            ...
                            break;
                        case"date_mm":
                            var k = t.gearDate.querySelector(".date_yy"), l = parseInt(k.getAttribute("val")), m = 11,
                                n = 0;
                            ...
                            break;
                        case"date_dd":
                            var k = t.gearDate.querySelector(".date_yy"), p = t.gearDate.querySelector(".date_mm"),
                                l = parseInt(k.getAttribute("val")), q = parseInt(p.getAttribute("val")), r = j(l, q),
                                s = r - 1, u = 0;
